comment `#####################################################
#
#  ffc.asm    31.03.2006 by fnt0m32 'at' gmail.com
#
#  FF Catcher v0.9.8
#
#  Used [MASM32 v8.2]
...
DlgProc proc uses ebx esi edi hwnd:HWND,msg:UINT,wParam:WPARAM,lParam:LPARAM
	...
	.elseif eax==WM_COMMAND
		...
		@@:
			...
			; send info
			;~~~~~~~~~~
			invoke	WriteFile,hCOM,addr send_buf,sizeof send_buf,addr cSent,addr ovr2
		@@:
