comment `#####################################################
#
#  ffc.asm    18.11.05 by fnt0m32 'at' gmail.com
#
#  FF Catcher v0.8
#
#  Used [MASM32 v8.2]
...
DlgProc proc uses ebx esi edi hwnd:HWND,msg:UINT,wParam:WPARAM,lParam:LPARAM
	...
	@@:
		...
		out_in_hex:
			...
			fdiv
			fstp	fp64
			invoke	FloatToStr,fp64,addr fp_buf
			invoke	SetDlgItemText,hwnd,IDC_TEMPERATURE,addr fp_buf
			pop		edi
