...
uses
  ...
  StdCtrls, Spin, GlobalVars, Menus, MPlayer;
...
type
  TDecision = class(TForm)
    ...
    procedure mmiWavClick(Sender: TObject);
  private
...
begin
//  if not Form1.HeCan then Exit; //TODO: Here!
...
var
  ...
  Second,hard: Boolean;
begin
  if Form1.mmiSpeed.Checked then
    begin
...
begin
  ...
  if Decision.mmiWav.Checked then Decision.MediaPlayer.Play
end;
...
procedure TDecision.mmiWavClick(Sender: TObject);
begin
  mmiWav.Checked:=not mmiWav.Checked
end;
